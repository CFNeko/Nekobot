...
class MCE(commands.Cog):
	...
	async def mce(self, ctx):
		...
		if ctx.invoked_subcommand is None:
			mce_embed = embedMaker.embedMaker('Mercenary Companies Expanded', 'https://steamcommunity.com/workshop/filedetails/?id=2125424517', 
												'Mercenaries at your behest',
                                                0x00fdff,
                                         		'Made by Vara & Uber',
			...
			await ctx.send(embed=mce_embed.t)
def setup(bot):
    bot.add_cog(MCE(bot))